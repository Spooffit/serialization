...
public class PersonFactory : IPersonFactory
{
    ...
    public Person Produce()
    {
        return new Person
        {
            ...
            CreditCardNumbers = _creditCardNumberProvider.ProvideArrange(new Random().Next(1, 5)).ToArray(),
            Age = new Random().Next(18, 61),
            Phones = _phoneProvider.ProvideArrange(new Random().Next(1, 5)).ToArray(),
